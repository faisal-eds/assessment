 ...
 */
package com.assessmenttask.core.models;
...
import com.assessmenttask.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "assessment-task/components/helloworld");
